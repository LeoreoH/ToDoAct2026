...
async function enviarDiagnostico() {
    ...
    try {
        ...
        const mensajesNivel = {
            facil: "🟠 Comenzarás con el Nivel 1 (Pueblo mágico) con instrucciones simples de 2-3 pasos.",
            normal: "🟡 ¡Buen trabajo! Irás al Nivel 2 (Jardín encantado) con orientación relativa y giros.",
            dificil: "⭐ ¡Excelente! Tienes un nivel avanzado. Irás al Nivel 3 (Isla del tesoro) con puntos cardinales."
        };
        ...
        document.getElementById("resultado").innerHTML = `
            <div style="text-align: center;">
                ...
                <p style="font-size: 18px; color: #E67E22;">Nivel asignado: <strong>${data.nivel_asignado}</strong></p>
