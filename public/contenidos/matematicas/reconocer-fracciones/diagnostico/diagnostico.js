...
async function enviarDiagnostico() {
    ...
    try {
        ...
        const mensajesNivel = {
            facil: "Empezarás con reconocimiento básico de partes y representaciones sencillas.",
            normal: "Trabajarás con comparación y lectura de fracciones de nivel intermedio.",
            dificil: "Ya puedes avanzar a retos más complejos con fracciones."
        };
