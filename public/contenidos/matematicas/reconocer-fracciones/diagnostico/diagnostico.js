const slug = "reconocer-fracciones";
...
async function enviarDiagnostico() {
    ...
    try {
        ...
        const mensajesNivel = {
            facil: "🟣 Comenzarás con ejercicios básicos para reconocer fracciones paso a paso.",
            normal: "🟪 ¡Buen trabajo! Irás al nivel intermedio de fracciones.",
        ...
        document.getElementById("resultado").innerHTML = `
            <div style="text-align: center;">
                ...
                <p style="font-size: 18px; color: #7b1fa2;">Nivel asignado: <strong>${data.nivel_asignado}</strong></p>
